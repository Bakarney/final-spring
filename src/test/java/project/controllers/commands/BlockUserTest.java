...
public class BlockUserTest {
    ...
    public void execute() throws Exception {
		...
		Mockito.when(userDAO.isActive(userId)).thenReturn(false);
    	
		blockUser.execute(request, response, model);
		
		Mockito.verify(userDAO).setStatus(userId, true);
